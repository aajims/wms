      ...
      >
        <ul class="kt-menu__nav ">
          ...
          >
            ...
            </svg></span><span class="kt-menu__link-text">Master</span><i class="kt-menu__ver-arrow la la-angle-right" /></a><div
              class="kt-menu__submenu "
              kt-hidden-height="10"
              style="display: none; overflow: hidden;"
            >
              <span class="kt-menu__arrow" /><ul class="kt-menu__subnav">
                <li
                  class="kt-menu__item  kt-menu__item--parent"
                  aria-haspopup="true"
                >
                  <span class="kt-menu__link"><span class="kt-menu__link-text">Master</span></span>
                </li><li
                  class="kt-menu__item "
                  aria-haspopup="true"
                >
                  <a
                    href="/warehouse"
                    class="kt-menu__link "
                  ><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span class="kt-menu__link-text">Warehouse</span></a>
                </li>
              </ul>
            </div>
          </li>
