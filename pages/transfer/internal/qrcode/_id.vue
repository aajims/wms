    ...
    <div>
      ...
      >
        <div
          ...
          class="container"
          style="margin: 0cm !important; width:98%; font-family: Arial, Helvetica, sans-serif; font-size: 8px; font-weight: bold; page-break-before:always;"
        >
            ...
            <table style="width: 100%;">
              <tr>
                ...
                >
                  Created:<br><br>
                  <div style="margin-top: -10px;">
                    <center><span style="font-size: 10px;">{{ date(internal.created_at) }}</span></center>
                  </div>
                </td>
              </tr>
            </table>
