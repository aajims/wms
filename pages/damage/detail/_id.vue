        ...
        <div class="kt-portlet__body">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-4 margin-top-20">
              ...
              <input
                :value="damage.from_warehouse_name"
                type="text"
                class="form-control"
                readonly
              >
            ...
            <div class="col-lg-4 margin-top-20">
              ...
              <input
                :value="damage.to_warehouse_name"
                type="text"
                class="form-control"
                readonly
              >
...
export default {
  ...
  async mounted () {
    ...
    try {
      ...
      this.damage    = this.$store.getters['damage/getDamageDetail'].result
      this.etd         = moment(this.damage.etd).format('DD/MM/Y HH:mm')
      this.eta         = moment(this.damage.eta).format('DD/MM/Y HH:mm')
      this.orderDate   = moment(this.damage.order_date).format('DD/MM/Y HH:mm')
      this.createdDate = moment(this.damage.created_at).format('DD/MM/Y HH:mm:ss')
      if (this.damage.shipment_date !== '' && this.damage.shipment_date !== '0000-00-00 00:00:00')
        this.shipmentDate = moment(this.damage.shipment_date).format('DD/MM/Y HH:mm')
      if (this.damage.updated_at !== '' && this.damage.updated_at !== null)
        this.updatedDate      = moment(this.damage.updated_at).format('DD/MM/Y HH:mm:ss')
      for (const statusIndex in JOB_STATUS) {
        if (this.damage.status === JOB_STATUS[statusIndex].id)
