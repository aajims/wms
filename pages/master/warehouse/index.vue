        ...
        },
        {
          ...
          render   : function (data, type, full, meta) {
            ...
            if (app.pageAccess.edit === app.statusTrue) {
              actionButtonEdit   = `<a href="/master/warehouse/edit/${full.id}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit Details"><i class="la la-edit"></i></a>`
            ...
            return `<a href="/master/warehouse/detail/${full.id}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View Details">
                      <i class="la la-eye"></i>
                    </a>
                    ${actionButtonEdit}
                    <span class="dropdown">
